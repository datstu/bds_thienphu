...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<ul class="nav menu">
			...
			<li class="parent"><a ><svg class="glyph stroked dashboard-dial">
						<use xlink:href="#stroked-dashboard-dial"></use>
					</svg>Tuyển dụng</a>
					<ul class="nav menu child"><li><a href=""><svg class="glyph stroked dashboard-dial">
						<use xlink:href="#stroked-dashboard-dial"></use>
					</svg>Tiếp nhận hồ sơ</a> </li>
				<li><a href="{{URL::to('/quan-ly-tuyen-dung')}}"><svg class="glyph stroked dashboard-dial">
						<use xlink:href="#stroked-dashboard-dial"></use>
					</svg>Quản lý Tuyển dụng</a></li></ul>
				</li>
