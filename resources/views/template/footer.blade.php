									...
									<div class="input-group">
										...
										<span class="input-group-btn">
											<button name="submit" value="Submit" type="submit"
												class="site-button radius-xl text-primary">Đăng ký</button>
										</span>
									</div>
								</form>
							</div>
							<ul class="list-inline m-a0 d-flex">
								<li><a href="https://www.facebook.com/diaocthienphutayninh" target="blank" class="site-button facebook circle "><i
											class="fab fa-facebook-f"></i></a></li>
								<li><a href="mailto:info.thienphutayninh@gmail.com" class="site-button google-plus circle "><i
											class="fab fa-google-plus-g"></i></a></li>
								<li><a href="#" class="site-button linkedin circle "><i
											class="fab fa-linkedin-in"></i></a></li>
								<li><a href="#" class="site-button instagram circle "><i
					...
					<div class="col-lg-4 col-md-4 footer-col-4">
						<div class="widget widget_getintuch">
							...
							<ul class="hover-a">
								...
								<a href="tel:<?= $phone ?>"><li><i class="fas fa-phone-alt"></i><strong>Điện thoại</strong><?= $phone ?></li></a>
								<a href="mailto:<?= $email ?>"><li><i class="fas fa-envelope"></i><strong>Email</strong><?= $email ?></li></a>
							</ul>
						</div>
					</div>
				</div>
...
<!-- Your Chat Plugin code --><!-- Messenger Chat Plugin Code -->
    <div id="fb-root"></div>
