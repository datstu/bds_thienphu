...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{asset('public/frontend/css/hotline.css')}}">
	<link rel="stylesheet" type="text/css" href="{{asset('public/frontend/css/recruit.css')}}">
	<!-- Google fonts -->
	<link
