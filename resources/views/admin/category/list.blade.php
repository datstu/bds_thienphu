                ...
                <div class="bootstrap-table">
                    <div class="table-responsive">
                        ...
                        <table class="table table-bordered" style="margin-top:20px;">
                            <thead>
                                <tr class="bg-primary">
                                    <th width="10%">Sản phẩm chủ lực</th>
                                    <th>Tên danh mục</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @if((int)$category->flagship > 0)
                                    <img width="20px" src="{{asset('public/backend/img/img-checked.png')}}">
                                    @endif
                                   </td>
                                    ...
                                    <td>
                                        ...
                                        Chưa có hình.
                                        @else
                                        <img width="200px" src="{{asset('public/uploads/category/'.$category->icon_svg)}}" class="thumbnail">
                                        @endif
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="{{URL::to('/cap-nhat-danh-muc/'.$category->category_id)}}" class="btn btn-warning"><i class="fa fa-pencil" aria-hidden="true"></i> Sửa</a>
                                        <a onclick="return confirm('Bạn muốn xóa danh mục {{$category->category_name}}?')" href="{{URL::to('/xoa-danh-muc/'.$category->category_id)}}" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i> Xóa</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
